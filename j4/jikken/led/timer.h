...
extern int timer_pri_set(int ch, int pri);
     /* 指定チャネルのタイマの割り込みのプライオリティをセットする関数 */
     /* 指定チャネルの範囲 ch: 0-4, プライオリティの値 pri: 0,1      */
     /* デフォルトでは、プライオリティの値が0と同じ状態になっている    */
     /* 指定チャネルやプライオリティ値が範囲外のときは何もしない       */
     /* 戻り値：正常処理は1、指定値の範囲が誤りのときは-1             */
